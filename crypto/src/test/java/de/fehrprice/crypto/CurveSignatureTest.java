 ...
 */
	...
	public void Test1Donna() {
		...
		assertEquals(signatureString, s);
		//messageString = "0d";
		assertTrue(fed.checkvalid(s,messageString,publicKeyString));
	}
