...
//		assertEquals(uOutString1Mio, scalarString);
	 ...
	 * Test curve25519 according to RFC 7748, section 6.1. test vectors
	 * Test Diffie-Hellman protocol.
	 * Use new implementation based on DJB's implementation
	 * and this adaption: https://github.com/mclab-hbrs/edu25519
	 */
	@Test
	public void TestDiffieHellmanEfficiency() {
		BigInteger uIn, uOut, bobPublicKey, alicePublicKey, secretKey;
		String uBasePoint, a, b, a_pub, b_pub, secret_k;
		byte[] scalar;
